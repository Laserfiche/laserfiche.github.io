...
# How to configure a Web Service Connection to Laserfiche Cloud API
...
1. Create or import a Laserfiche Cloud API Web Service Connection:

For Laserfiche Repository API:
...
For Laserfiche OData Table API:

- [Laserfiche API OData Table US Cloud - Web Service Connection.dsi](./assets/Laserfiche%20API%20OData%20Table%20US%20Cloud%20-%20Web%20Service%20Connection.dsi)
- [Laserfiche API OData Table Canada Cloud - Web Service Connection.dsi](./assets/Laserfiche%20API%20OData%20Table%20Canada%20Cloud%20-%20Web%20Service%20Connection.dsi)
- [Laserfiche API OData Table Europe Cloud - Web Service Connection.dsi](./assets/Laserfiche%20API%20OData%20Table%20Europe%20Cloud%20-%20Web%20Service%20Connection.dsi)
...
1. Authentication step: Specify the [scopes](./../../../api/authentication/guide_oauth_2.0_scopes/) required to access the underlining resources.
...
1. Authentication step: Test and Save the Web Service Connection
