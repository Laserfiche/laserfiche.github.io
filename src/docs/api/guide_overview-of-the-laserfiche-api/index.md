...
| [Laserfiche Repository API V2](../repository-api-reference/)  | &#x2713;<br/>[Changelog](https://api.laserfiche.com/repository/v2/changelog) |           &#x2265; 12<br/>Requires [Laserfiche API Server](../server/)            | HTTP REST, [client libraries](../libraries/) | Interact with Laserfiche's repositories, documents, and metadata                                  |
