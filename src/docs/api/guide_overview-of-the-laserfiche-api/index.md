...
|Service Limits| [API Limits](../../getting-started/guide_api-limits/) | No explicit service limits. The number of concurrent API calls available to a user is dependent on the number of concurrent LFS connections available to that user. |
