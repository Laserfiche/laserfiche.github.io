...
| ------------------------------------------------------------- | :--------------------------------------------------------------------------: | :-------------------------------------------------------------------------------: | -------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [Laserfiche OAuth 2.0](../authentication/)                    |                                   &#x2713;                                   | Authorize and Token endpoints are available for V2 with LFDS (LFDSSTS) configured | HTTP REST,<br>OAuth 2.0                      | Authorize Sign-In page and Token endpoint                                                         |
...
| Security features               | - JWT Access Token<br/>- [OAuth 2.0 Scopes](../authentication/guide_oauth_2.0_scopes/)<br/>- User Consent Form on first Sign-in (can be disabled)<br/>- [Requires App registration in Developer Console](../../getting-started/developer-console/)                                                                                                                                                                                               | - JWT Access Token <br/> - When using LFDS the redirect URI must be whitelisted in appsettings.json and the API Login page must be whitelisted in LFDSSTS |
