...
| [Laserfiche Workflow SDK](https://support.laserfiche.com/resources/2411/getting-started-with-the-workflow-sdk-visual-c) | N/A | &#x2713; | .NET Framework 4.8 | Extend the functionality of Laserfiche Workflow with custom code |
...
|Service Limits| [API Limits](../../getting-started/guide_api-limits/) | No explicit service limits. The number of concurrent API calls available to a user is dependent on the [ type of API call, user license type, and server configuration](../repository-api-reference/server/). |
