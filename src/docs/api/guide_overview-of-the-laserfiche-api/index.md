...
| ------------------------------------------------------------- | :--------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------: | -------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [Laserfiche OAuth 2.0](../authentication/)                    |                                   &#x2713;                                   | Authorize and Token endpoints are available for V2 with Laserfiche Directory Server (LFDSSTS) configured | HTTP REST,<br>OAuth 2.0                      | Authorize Sign-In page and Token endpoint                                                         |
| [Collections API](../collections-api-reference/)              |                                   &#x2713;                                   |                                                   N/A                                                    | HTTP REST,<br>Basic Authentication           | Manage vectorized document collections                                                            |
| [Laserfiche Repository API V2](../repository-api-reference/)  | &#x2713;<br/>[Changelog](https://api.laserfiche.com/repository/v2/changelog) |                       &#x2265; 11<br/>Requires [Laserfiche API Server](../server/)                       | HTTP REST, [client libraries](../libraries/) | Interact with Laserfiche's repositories, documents, and metadata                                  |
...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| API Endpoints                   | - [Canada](./../../getting-started/playground/) Data Center<br/> - [European Union](./../../getting-started/playground/) Data Center<br/> - [United States](./../../getting-started/playground/) Data Center                                                                                                                                                                                                                                     | Self-Hosted [Laserfiche API Server](../server/)                                                                                                                                                                               |
| API Explorer                    | [Swagger Playground](./../../getting-started/playground/)                                                                                                                                                                                                                                                                                                                                                                                        | [Swagger UI](https://swagger.io/tools/swagger-ui/) at<br/>https://[YOUR-LASERFICHE-API-SERVER](../server/)/LFRepositoryAPI/                                                                                                   |
| Authentication<br/>Frameworks   | - OAuth 2.0 client_credentials (Service Principals)<br/>- OAuth 2.0 authorization_code & refresh_token (User Sign-in Page)<br/>- HTTP Basic supported for [Laserfiche OData API](../odata-api-reference/)                                                                                                                                                                                                                                        | - Token endpoint (username & password)<br/> - Login using Laserfiche Directory Server (Authorize and Token endpoints similar to Cloud OAuth SPA support)                                                                      |
| Authentication<br/>User Types   | - [Full](https://doc.laserfiche.com/laserfiche/en-us/content/admin-account-user-licenses.htm) Users<br/> - [Participant](https://doc.laserfiche.com/laserfiche/en-us/content/admin-account-user-licenses.htm) Users (Read Only Access)<br/> - [Community](https://doc.laserfiche.com/laserfiche/en-us/content/admin-account-user-licenses.htm) Users (Read Only Access)<br/> - [Service Principals](../authentication/guide_service-principals/) | - Laserfiche Directory Server Users<br/>- Repository Users<br/>- Keyed Integrator Licenses                                                                                                                                    |
...
| Security features               | - JWT Access Token<br/>- [OAuth 2.0 Scopes](../authentication/guide_oauth_2.0_scopes/)<br/>- User Consent Form on first Sign-in (can be disabled)<br/>- [Requires App registration in Developer Console](../../getting-started/developer-console/)                                                                                                                                                                                               | - JWT Access Token <br/> - When using Laserfiche Directory Server the redirect URI must be added to an allow list in appsettings.json and the API Login page must be on the allow list in the Laserfiche Directory Server STS |
