...
- Learn how to [create a connection using the authorization_code flow with Laserfiche Directory Server](../server/authentication/#authorize-code-flow-with-lfds).
