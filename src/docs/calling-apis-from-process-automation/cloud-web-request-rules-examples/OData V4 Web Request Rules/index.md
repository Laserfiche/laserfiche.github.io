...
- If connecting to [Laserfiche OData Table API](https://developer.laserfiche.com/docs/api/odata-api-reference/), follow these instructions: [How to configure a Web Service Connection to Laserfiche Cloud API](../../laserfiche-cloud-api-web-service-connections/#laserfiche-odata-table-api-web-service-connection)
