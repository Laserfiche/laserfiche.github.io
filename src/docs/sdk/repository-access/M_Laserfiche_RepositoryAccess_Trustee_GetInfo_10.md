# Trustee.GetInfo Method (String, ISession)
...
#### Parameters
&nbsp;<dl><dt>trusteeName</dt><dd>Type: System.String<br />The name of the Laserfiche account to retrieve Laserfiche trustee information for.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
