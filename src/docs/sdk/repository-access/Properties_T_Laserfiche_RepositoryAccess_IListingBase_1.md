# IListingBase(*T*) Properties
 

The <a href="T_Laserfiche_RepositoryAccess_IListingBase_1">IListingBase(T)</a> generic type exposes the following members.
...
<a href="#ilistingbase(*t*)-properties">Back to Top</a>
