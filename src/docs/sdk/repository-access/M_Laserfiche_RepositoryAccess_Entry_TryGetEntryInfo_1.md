# Entry.TryGetEntryInfo Method (Guid, ISession)
...
#### Parameters
&nbsp;<dl><dt>entryUuid</dt><dd>Type: System.Guid<br />The UUID of the entry in the current repository to return an `EntryInfo` instance for.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
