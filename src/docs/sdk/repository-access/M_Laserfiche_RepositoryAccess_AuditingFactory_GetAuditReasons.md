# AuditingFactory.GetAuditReasons Method (AccountReference, AuditEventType, ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IAuditingFactory_GetAuditReasons">IAuditingFactory.GetAuditReasons(AccountReference, AuditEventType, ISession)</a><br />
