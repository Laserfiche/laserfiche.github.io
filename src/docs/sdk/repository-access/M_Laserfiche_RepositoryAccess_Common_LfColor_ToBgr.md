# LfColor.ToBgr Method 
 

Returns an integer representing the color value stored in this object in BGR byte order. The alpha component is left at zero.
...
#### Return Value
Type: Int32<br />An integer representing a color in BGR byte order.
