# Trustee.GetAttributes Method (LFIdentityReference, ISession)
 

Returns a `TrusteeAttributeCollection` instance which represents the set of trustee attributes for the specified trustee.
...
#### Parameters
&nbsp;<dl><dt>ident</dt><dd>Type: <a href="T_LfPortable_Security_Principal_LFIdentityReference">LfPortable.Security.Principal.LFIdentityReference</a><br />An `IdentityReference` which represents a reference to the trustee to retrieve the attribute collection for.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>

#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_TrusteeAttributeCollection">TrusteeAttributeCollection</a><br />A `TrusteeAttributeCollection` instance which represents the set of trustee attributes for the specified trustee.
