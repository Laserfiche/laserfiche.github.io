...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IEntryInfo_Lock">IEntryInfo.Lock(LockType, Nullable(TimeSpan), String, LockExtent)</a><br /><a href="M_Laserfiche_RepositoryAccess_IEntryInfo_Lock">IEntryInfo.Lock(LockType, Nullable(TimeSpan), String, LockExtent)</a><br />
