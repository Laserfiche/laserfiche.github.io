# Field.MergeFields Method (IEnumerable(FieldInfo), String, FieldMergeResolutionStrategy, FieldMergeOptions, ISession)
...
Public Shared Function MergeFields ( 
	sourceFields As IEnumerable(Of FieldInfo),
