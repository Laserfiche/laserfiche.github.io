# DocumentFactory.TryGetVersionGroup Method 
...
**C#**<br />
``` C#
public VersionGroup TryGetVersionGroup(
	int entryId,
	ISession session
)
```
...
**VB**<br />
``` VB
Public Function TryGetVersionGroup ( 
	entryId As Integer,
	session As ISession
) As VersionGroup
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_VersionGroup">VersionGroup</a>

#### Implements
<a href="M_Laserfiche_RepositoryAccess_IDocumentFactory_TryGetVersionGroup">IDocumentFactory.TryGetVersionGroup(Int32, ISession)</a><br />
