# FieldFactory.BatchGetDefaultAclDisplayRights Method (IEnumerable(LFSecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IFieldFactory_BatchGetDefaultAclDisplayRights_1">IFieldFactory.BatchGetDefaultAclDisplayRights(IEnumerable(LFSecurityIdentifier), ISession)</a><br />
