# ReleaseEntryActivity.ActivityMask Property 
 

Gets a mask which represents which activities occured with the lock for the RELEASE notification. The mask values correspond to members of the `ActivityType` enumeration.
...
**C#**<br />
``` C#
public int ActivityMask { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property ActivityMask As Integer
	Get
```
