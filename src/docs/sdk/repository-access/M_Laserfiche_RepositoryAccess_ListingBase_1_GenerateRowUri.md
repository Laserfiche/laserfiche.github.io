# ListingBase(*T*).GenerateRowUri Method 
...
**C#**<br />
``` C#
protected abstract string GenerateRowUri(
	int rowIndex
)
```
...
**VB**<br />
``` VB
Protected MustOverride Function GenerateRowUri ( 
	rowIndex As Integer
) As String
```
...
#### Parameters
&nbsp;<dl><dt>rowIndex</dt><dd>Type: System.Int32<br /></dd></dl>
