# RecycleBinFactory.GetListing Method (RecycleBinColumn, SortDirection, LFSecurityIdentifier, ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IRecycleBinFactory_GetListing_1">IRecycleBinFactory.GetListing(RecycleBinColumn, SortDirection, LFSecurityIdentifier, ISession)</a><br />
