# ISecureLaserficheObject Interface
...
**C#**<br />
``` C#
public interface ISecureLaserficheObject : ILaserficheObject
```

**VB**<br />
``` VB
Public Interface ISecureLaserficheObject
	Inherits ILaserficheObject
```

The ISecureLaserficheObject type exposes the following members.
...
<a href="#isecurelaserficheobject-interface">Back to Top</a>
