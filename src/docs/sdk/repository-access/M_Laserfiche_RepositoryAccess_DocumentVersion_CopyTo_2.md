# DocumentVersion.CopyTo Method (String, String, String, EntryNameOption)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IDocumentVersion_CopyTo_2">IDocumentVersion.CopyTo(String, String, String, EntryNameOption)</a><br />
