# ModifyPropdefActivityMessage.OldPropertyNameFieldNumber Field
 

Field number for the "old_property_name" field.
...
**C#**<br />
``` C#
public const int OldPropertyNameFieldNumber = 6
```

**VB**<br />
``` VB
Public Const OldPropertyNameFieldNumber As Integer = 6
```
