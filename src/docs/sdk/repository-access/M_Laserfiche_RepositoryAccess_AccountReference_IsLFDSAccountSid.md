# AccountReference.IsLFDSAccountSid Method 
 

Determines if the specified `SecurityIdentifier` potentially identifies an LFDS account.
...
**C#**<br />
``` C#
public static bool IsLFDSAccountSid(
...
**VB**<br />
``` VB
Public Shared Function IsLFDSAccountSid ( 
...
#### Return Value
Type: Boolean<br />True if the specified `SecurityIdentifier` potentially identifies an LFDS account, false otherwise.
