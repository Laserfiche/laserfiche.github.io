...
**C#**<br />
``` C#
public bool FallBackToWmi { get; set; }
```

**VB**<br />
``` VB
Public Property FallBackToWmi As Boolean
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IServer_FallBackToWmi">IServer.FallBackToWmi</a><br />
