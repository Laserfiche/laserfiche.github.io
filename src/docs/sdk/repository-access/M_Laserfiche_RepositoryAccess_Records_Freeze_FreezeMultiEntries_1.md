# Freeze.FreezeMultiEntries Method (IEntryInfo[], String, ISession)
...
#### Parameters
&nbsp;<dl><dt>entryInfos</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_IEntryInfo">Laserfiche.RepositoryAccess.IEntryInfo</a>[]<br />The entries that will be frozen.</dd><dt>reason</dt><dd>Type: System.String<br />The freeze reason.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
