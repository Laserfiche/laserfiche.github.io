# Volume.BatchGetDefaultAclDisplayRights Method (IEnumerable(LFSecurityIdentifier), ISession)
 

Batch retrieves the ACL display rights for the input Laserfiche accounts assuming a volume with the default ACL.
...
#### Return Value
Type: Dictionary(<a href="T_LfPortable_Security_Principal_LFSecurityIdentifier">LFSecurityIdentifier</a>, Int32)<br />a `Dictionary` mapping `SecurityIdentifier` of accounts to one or more values from the `VolumeRights` enumeration representing the ACL display rights for the specified Laserfiche account assuming a volume with the default ACL.

## See Also


#### Reference
<a href="T_Laserfiche_RepositoryAccess_Volume">Volume Class</a><br /><a href="Overload_Laserfiche_RepositoryAccess_Volume_BatchGetDefaultAclDisplayRights">BatchGetDefaultAclDisplayRights Overload</a><br /><a href="N_Laserfiche_RepositoryAccess">Laserfiche.RepositoryAccess Namespace</a><br />