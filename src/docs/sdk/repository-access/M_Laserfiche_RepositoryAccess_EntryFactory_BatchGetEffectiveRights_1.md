# EntryFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(LFSecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IEntryFactory_BatchGetEffectiveRights_1">IEntryFactory.BatchGetEffectiveRights(IEnumerable(Int32), IEnumerable(LFSecurityIdentifier), ISession)</a><br />
