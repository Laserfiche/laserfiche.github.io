# AuditingFactory.GetAuditReasons Method (String, AuditEventType, ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IAuditingFactory_GetAuditReasons_3">IAuditingFactory.GetAuditReasons(String, AuditEventType, ISession)</a><br />
