# GeoConverter.DecodeLineStringZM Method 
 

Convert to an instance of `WkbLineStringZM` from the wkb
...
**C#**<br />
``` C#
public static LineStringZM DecodeLineStringZM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeLineStringZM ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineStringZM">LineStringZM</a><br />An instance of `WkbLineStringZM`
