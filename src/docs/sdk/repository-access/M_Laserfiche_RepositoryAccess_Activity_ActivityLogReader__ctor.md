# ActivityLogReader Constructor (ISession)
 

Initializes an `ActivityLogReader` instance configured to read the entire activity log in ascending order.
...
#### Parameters
&nbsp;<dl><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The `Session` instance to connect to Laserfiche with.</dd></dl>
