# NamedUserDatabase.RegisterNamedUser Method (NamedUser)
...
#### Parameters
&nbsp;<dl><dt>user</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_Admin_NamedUser">Laserfiche.RepositoryAccess.Admin.NamedUser</a><br /></dd></dl>
