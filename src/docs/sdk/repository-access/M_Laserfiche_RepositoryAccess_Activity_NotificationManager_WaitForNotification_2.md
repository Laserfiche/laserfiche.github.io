# NotificationManager.WaitForNotification Method (TimeSpan)
...
#### Parameters
&nbsp;<dl><dt>timeout</dt><dd>Type: System.TimeSpan<br />A `TimeSpan` value indicating how long to wait for a notification to be received.</dd></dl>
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_Activity_INotificationManager_WaitForNotification_2">INotificationManager.WaitForNotification(TimeSpan)</a><br />
