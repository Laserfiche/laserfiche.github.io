# GeoConverter.ParseLineStringZ Method 
 

Convert to an instance of `WkbLineStringZ` from the wkt
...
**C#**<br />
``` C#
public static LineStringZ ParseLineStringZ(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseLineStringZ ( 
	wkt As String
) As LineStringZ
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineStringZ">LineStringZ</a><br />An instance of `WkbStringLineZ`
