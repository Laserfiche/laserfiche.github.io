# ModifyPropdefActivityMessage.OldPropertyTypeFieldNumber Field
 

Field number for the "old_property_type" field.
...
**C#**<br />
``` C#
public const int OldPropertyTypeFieldNumber = 8
```

**VB**<br />
``` VB
Public Const OldPropertyTypeFieldNumber As Integer = 8
```
