# BusinessProcessEntityInfo.AddAssociatedTrustee Method (SecurityIdentifier)
...
Public Function AddAssociatedTrustee ( 
	newSid As SecurityIdentifier
) As Boolean
```


#### Parameters
&nbsp;<dl><dt>newSid</dt><dd>Type: System.Security.Principal.SecurityIdentifier<br />A `SecurityIdentifier` instance representing the security identifier (SID) to add.</dd></dl>
