# ListingBase(*T*).MarkedRowCount Property 
...
**C#**<br />
``` C#
public int MarkedRowCount { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property MarkedRowCount As Integer
	Get
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IListingBase_1_MarkedRowCount">IListingBase(T).MarkedRowCount</a><br />
