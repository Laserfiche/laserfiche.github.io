# Document.ReadLocationsPagePart Method 
 

Returns a `WordLocationsReader` instance which can be used to read the specified page's OCR locations data.
...
**C#**<br />
``` C#
public static WordLocationsReader ReadLocationsPagePart(
	int entryId,
	int pageNum,
	ISession session
)
...
**VB**<br />
``` VB
Public Shared Function ReadLocationsPagePart ( 
	entryId As Integer,
	pageNum As Integer,
	session As ISession
) As WordLocationsReader
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_WordLocationsReader">WordLocationsReader</a><br />A `WordLocationsReader` instance which can be used to read the specified page's OCR locations data.
