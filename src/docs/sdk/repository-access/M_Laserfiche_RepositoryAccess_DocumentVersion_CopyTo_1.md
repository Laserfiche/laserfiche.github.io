# DocumentVersion.CopyTo Method (IFolderInfo, String, String, EntryNameOption)
...
#### Parameters
&nbsp;<dl><dt>parent</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_IFolderInfo">Laserfiche.RepositoryAccess.IFolderInfo</a><br />The destination folder.</dd><dt>name</dt><dd>Type: System.String<br />The name of the new document.</dd><dt>targetVol</dt><dd>Type: System.String<br />The name of the volume that the new document will reside in, or null for the default.</dd><dt>options</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_EntryNameOption">Laserfiche.RepositoryAccess.EntryNameOption</a><br />One or more members of the `EntryNameOption` enumeration that will control how the new entry is named.</dd></dl>

#### Return Value
Type: Int32<br />The entry ID of the new document.

#### Implements
<a href="M_Laserfiche_RepositoryAccess_IDocumentVersion_CopyTo_1">IDocumentVersion.CopyTo(IFolderInfo, String, String, EntryNameOption)</a><br />
