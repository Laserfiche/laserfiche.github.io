# ModifyPropdefActivityMessage.PropertyTypeFieldNumber Field
 

Field number for the "property_type" field.
...
**C#**<br />
``` C#
public const int PropertyTypeFieldNumber = 4
```

**VB**<br />
``` VB
Public Const PropertyTypeFieldNumber As Integer = 4
```
