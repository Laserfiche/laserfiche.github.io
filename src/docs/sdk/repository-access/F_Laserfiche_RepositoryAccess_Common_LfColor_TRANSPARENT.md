# LfColor.TRANSPARENT Field
 

An `LfColor` value representing a totally transparent color value.
...
**C#**<br />
``` C#
public static readonly LfColor TRANSPARENT
```

**VB**<br />
``` VB
Public Shared ReadOnly TRANSPARENT As LfColor
```
