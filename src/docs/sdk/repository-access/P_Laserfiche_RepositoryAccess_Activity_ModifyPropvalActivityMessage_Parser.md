# ModifyPropvalActivityMessage.Parser Property 
...
**C#**<br />
``` C#
public static MessageParser<ModifyPropvalActivityMessage> Parser { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Parser As MessageParser(Of ModifyPropvalActivityMessage)
	Get
```


#### Property Value
Type: MessageParser(<a href="T_Laserfiche_RepositoryAccess_Activity_ModifyPropvalActivityMessage">ModifyPropvalActivityMessage</a>)
