# LFSecurityIdentifier.AccountDomainSid Property 
...
**C#**<br />
``` C#
public LFSecurityIdentifier AccountDomainSid { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property AccountDomainSid As LFSecurityIdentifier
	Get
```
