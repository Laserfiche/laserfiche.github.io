# GeoConverter.DecodeMultiPolygonM Method 
 

Convert to an instance of `WkbMultiPolygonM` from the wkb
...
**C#**<br />
``` C#
public static MultiPolygonM DecodeMultiPolygonM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPolygonM ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPolygonM">MultiPolygonM</a><br />An instance of `WkbMultiPolygonM`
