# GeoConverter.DecodeMultiPolygonZM Method 
 

Convert to an instance of `WkbMultiPolygonZM` from the wkb
...
**C#**<br />
``` C#
public static MultiPolygonZM DecodeMultiPolygonZM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPolygonZM ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPolygonZM">MultiPolygonZM</a><br />An instance of `WkbMultiPolygonZM`
