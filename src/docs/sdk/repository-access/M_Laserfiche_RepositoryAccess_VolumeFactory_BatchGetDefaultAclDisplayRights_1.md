# VolumeFactory.BatchGetDefaultAclDisplayRights Method (IEnumerable(LFSecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IVolumeFactory_BatchGetDefaultAclDisplayRights_1">IVolumeFactory.BatchGetDefaultAclDisplayRights(IEnumerable(LFSecurityIdentifier), ISession)</a><br />
