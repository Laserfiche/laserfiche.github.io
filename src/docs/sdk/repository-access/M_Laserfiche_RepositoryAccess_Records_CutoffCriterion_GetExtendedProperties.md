# CutoffCriterion.GetExtendedProperties Method (ISession)
...
#### Return Value
Type: List(<a href="T_Laserfiche_RepositoryAccess_PropResponse">PropResponse</a>)<br />All the system and custom properties for all cutoff criteria.
