...
Represents an error indicating malformed data was received from Laserfiche. Try restarting the request and verifying network connectivity.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.Exception<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_LaserficheRepositoryException">Laserfiche.RepositoryAccess.LaserficheRepositoryException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Laserfiche.RepositoryAccess.MalformedDataException<br />
...
public class MalformedDataException : LaserficheRepositoryException
```
...
The MalformedDataException type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_MalformedDataException__ctor">MalformedDataException()</a></td><td>
Initializes a `MalformedDataException` instance.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_MalformedDataException__ctor_2">MalformedDataException(String)</a></td><td>
Initializes a `MalformedDataException` instance with the specified message.</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Laserfiche_RepositoryAccess_MalformedDataException__ctor_1">MalformedDataException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the MalformedDataException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_MalformedDataException__ctor_3">MalformedDataException(String, Exception)</a></td><td>
Initializes a `MalformedDataException` instance with the specified message and inner exception.</td></tr></table>&nbsp;
<a href="#malformeddataexception-class">Back to Top</a>
