# AuditEvent.AuditReasonId Property 
...
**VB**<br />
``` VB
Public Property AuditReasonId As Integer
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IAuditEvent_AuditReasonId">IAuditEvent.AuditReasonId</a><br />
