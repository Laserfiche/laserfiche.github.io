# ModifyPropdefActivityMessage.PropertyFlagsFieldNumber Field
 

Field number for the "property_flags" field.
...
**C#**<br />
``` C#
public const int PropertyFlagsFieldNumber = 3
```

**VB**<br />
``` VB
Public Const PropertyFlagsFieldNumber As Integer = 3
```
