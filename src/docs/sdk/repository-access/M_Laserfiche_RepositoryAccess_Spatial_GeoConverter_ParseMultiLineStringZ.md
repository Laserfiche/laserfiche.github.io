# GeoConverter.ParseMultiLineStringZ Method 
 

Convert to an instance of `WkbMultiLineStringZ` from the wkt
...
**C#**<br />
``` C#
public static MultiLineStringZ ParseMultiLineStringZ(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseMultiLineStringZ ( 
	wkt As String
) As MultiLineStringZ
```
