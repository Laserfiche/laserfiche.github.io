# IEntryFactory.BatchGetEffectiveRightsEx Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
**C#**<br />
``` C#
Dictionary<int, Dictionary<AccountReference, DetailedEffectiveAccess>> BatchGetEffectiveRightsEx(
