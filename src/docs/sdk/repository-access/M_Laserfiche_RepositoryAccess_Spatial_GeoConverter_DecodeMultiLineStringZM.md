# GeoConverter.DecodeMultiLineStringZM Method 
 

Convert to an instance of `WkbMultiLineStringZM` from the wkb
...
**C#**<br />
``` C#
public static MultiLineStringZM DecodeMultiLineStringZM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiLineStringZM ( 
	wkb As Byte(),
