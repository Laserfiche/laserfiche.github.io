# ModifyPropvalActivityMessage.PropertyValueFieldNumber Field
 

Field number for the "property_value" field.
...
**C#**<br />
``` C#
public const int PropertyValueFieldNumber = 9
```

**VB**<br />
``` VB
Public Const PropertyValueFieldNumber As Integer = 9
```
