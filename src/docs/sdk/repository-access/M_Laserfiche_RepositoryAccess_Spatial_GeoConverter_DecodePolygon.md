# GeoConverter.DecodePolygon Method 
 

Convert to an instance of `WkbPolygon` from the wkb
...
**C#**<br />
``` C#
public static Polygon DecodePolygon(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodePolygon ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_Polygon">Polygon</a><br />An instance of `WkbPolygon`
