# Account.UnlinkWindowsAccounts Method (String, IEnumerable(SecurityIdentifier), ISession)
...
#### Parameters
&nbsp;<dl><dt>accountName</dt><dd>Type: System.String<br /></dd><dt>winSids</dt><dd>Type: System.Collections.Generic.IEnumerable(SecurityIdentifier)<br /></dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br /></dd></dl>
