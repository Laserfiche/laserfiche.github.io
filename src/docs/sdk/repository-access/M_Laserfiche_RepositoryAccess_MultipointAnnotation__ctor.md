# MultipointAnnotation Constructor 
 

Initializes a new instance of the <a href="T_Laserfiche_RepositoryAccess_MultipointAnnotation">MultipointAnnotation</a> class
...
**C#**<br />
``` C#
protected MultipointAnnotation(
