...
**VB**<br />
``` VB
Public Overridable ReadOnly Property LockToken As String
	Get
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IEntryInfo_LockToken">IEntryInfo.LockToken</a><br />
