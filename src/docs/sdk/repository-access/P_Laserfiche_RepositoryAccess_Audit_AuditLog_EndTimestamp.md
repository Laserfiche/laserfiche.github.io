# AuditLog.EndTimestamp Property 
...
**VB**<br />
``` VB
Public ReadOnly Property EndTimestamp As DateTime
	Get
```
...
#### Reference
<a href="T_Laserfiche_RepositoryAccess_Audit_AuditLog">AuditLog Class</a><br /><a href="N_Laserfiche_RepositoryAccess_Audit">Laserfiche.RepositoryAccess.Audit Namespace</a><br />