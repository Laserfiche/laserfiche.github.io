# FieldFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IFieldFactory_BatchGetEffectiveRights">IFieldFactory.BatchGetEffectiveRights(IEnumerable(Int32), IEnumerable(AccountReference), ISession)</a><br />
