# Search.ContextHitLength Property 
...
**C#**<br />
``` C#
public int ContextHitLength { get; set; }
```

**VB**<br />
``` VB
Public Property ContextHitLength As Integer
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_ISearch_ContextHitLength">ISearch.ContextHitLength</a><br />
