# GeoConverter.DecodeLineStringM Method 
 

Convert to an instance of `WkbLineStringM` from the wkb
...
**C#**<br />
``` C#
public static LineStringM DecodeLineStringM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeLineStringM ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineStringM">LineStringM</a><br />An instance of `WkbLineStringM`
