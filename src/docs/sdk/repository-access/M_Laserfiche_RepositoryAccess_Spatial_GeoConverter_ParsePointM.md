# GeoConverter.ParsePointM Method 
 

Convert to an instance of `WkbPointM` from the wkt
...
**C#**<br />
``` C#
public static PointM ParsePointM(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParsePointM ( 
	wkt As String
) As PointM
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_PointM">PointM</a><br />An instance of `WkbPointM`
