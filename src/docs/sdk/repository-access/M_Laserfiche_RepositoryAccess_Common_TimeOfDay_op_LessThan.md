# TimeOfDay.LessThan Operator 
 

Determines if the *tod1* argument represents a point in time before the *tod2* argument.
...
#### Return Value
Type: Boolean<br />True if the first argument represents a time before the second, false otherwise.
