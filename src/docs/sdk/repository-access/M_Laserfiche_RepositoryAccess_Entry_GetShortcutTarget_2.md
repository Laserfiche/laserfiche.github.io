# Entry.GetShortcutTarget Method (Int32, ISession)
...
#### Parameters
&nbsp;<dl><dt>shortcutId</dt><dd>Type: System.Int32<br />The entry ID of the shortcut whose target entry shall be returned.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
