# DispositionScheduleInfo Constructor (ISession)
 

Initializes an instance of `DispositionScheduleInfo` representing a new disposition schedule with no final disposition or interim transfers.
...
**C#**<br />
``` C#
public DispositionScheduleInfo(
	ISession session
)
```
