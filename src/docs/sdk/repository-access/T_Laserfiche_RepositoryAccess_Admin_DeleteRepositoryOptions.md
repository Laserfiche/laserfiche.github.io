# DeleteRepositoryOptions Enumeration
...
``` C#
[FlagsAttribute]
public enum DeleteRepositoryOptions
```

**VB**<br />
``` VB
<FlagsAttribute>
Public Enumeration DeleteRepositoryOptions
```


## Members
&nbsp;<table><tr><th></th><th>Member name</th><th>Value</th><th>Description</th></tr><tr><td /><td target="F:Laserfiche.RepositoryAccess.Admin.DeleteRepositoryOptions.None">**None**</td><td>0</td><td>No option specified.</td></tr><tr><td /><td target="F:Laserfiche.RepositoryAccess.Admin.DeleteRepositoryOptions.ForceUnmount">**ForceUnmount**</td><td>1</td><td>Force the repository to be unmounted if necessary.</td></tr></table>
