# Trustee.GetLinkedAccounts Method (LFIdentityReference, ISession)
 

Returns an `AccountReferenceCollection` instance containing `AccountReference` instances for trustees linked to the specified trustee.
