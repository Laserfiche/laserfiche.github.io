# Volume.GetAclDisplayRights Method (Int32, IdentityReference, ISession)
...
#### Parameters
&nbsp;<dl><dt>volumeId</dt><dd>Type: System.Int32<br />The ID of the volume to return rights that the specified user is granted access to by the volume's security configuration.</dd><dt>ident</dt><dd>Type: System.Security.Principal.IdentityReference<br />An `IdentityReference` instance which represents a reference to a Windows trustee.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
