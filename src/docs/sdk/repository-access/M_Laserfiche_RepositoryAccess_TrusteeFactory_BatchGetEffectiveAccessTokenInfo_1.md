# TrusteeFactory.BatchGetEffectiveAccessTokenInfo Method (IEnumerable(SecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_ITrusteeFactory_BatchGetEffectiveAccessTokenInfo_1">ITrusteeFactory.BatchGetEffectiveAccessTokenInfo(IEnumerable(SecurityIdentifier), ISession)</a><br />
