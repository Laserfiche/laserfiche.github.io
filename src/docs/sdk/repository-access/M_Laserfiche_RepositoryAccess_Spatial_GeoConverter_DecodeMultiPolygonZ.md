# GeoConverter.DecodeMultiPolygonZ Method 
 

Convert to an instance of `WkbMultiPolygonZ` from the wkb
...
**C#**<br />
``` C#
public static MultiPolygonZ DecodeMultiPolygonZ(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPolygonZ ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPolygonZ">MultiPolygonZ</a><br />An instance of `WkbMultiPolygonZ`
