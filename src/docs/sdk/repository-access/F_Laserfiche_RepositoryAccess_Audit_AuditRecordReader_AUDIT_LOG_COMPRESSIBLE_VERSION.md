# AuditRecordReader.AUDIT_LOG_COMPRESSIBLE_VERSION Field
...
**C#**<br />
``` C#
public const int AUDIT_LOG_COMPRESSIBLE_VERSION = 2
```

**VB**<br />
``` VB
Public Const AUDIT_LOG_COMPRESSIBLE_VERSION As Integer = 2
```
