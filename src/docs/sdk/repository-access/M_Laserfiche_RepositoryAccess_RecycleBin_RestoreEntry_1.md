# RecycleBin.RestoreEntry Method (Int32, String, ISession)
...
**C#**<br />
``` C#
public static void RestoreEntry(
	int entryId,
	string newPath,
	ISession session
)
...
**VB**<br />
``` VB
Public Shared Sub RestoreEntry ( 
	entryId As Integer,
	newPath As String,
	session As ISession
)
...
#### Reference
<a href="T_Laserfiche_RepositoryAccess_RecycleBin">RecycleBin Class</a><br /><a href="Overload_Laserfiche_RepositoryAccess_RecycleBin_RestoreEntry">RestoreEntry Overload</a><br /><a href="N_Laserfiche_RepositoryAccess">Laserfiche.RepositoryAccess Namespace</a><br />