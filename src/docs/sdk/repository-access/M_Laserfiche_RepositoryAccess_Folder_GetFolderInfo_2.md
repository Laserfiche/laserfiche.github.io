# Folder.GetFolderInfo Method (String, ISession)
...
#### Parameters
&nbsp;<dl><dt>path</dt><dd>Type: System.String<br />The path to the folder in the repository.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
