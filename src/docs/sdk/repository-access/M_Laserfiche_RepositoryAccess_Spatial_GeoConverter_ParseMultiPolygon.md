# GeoConverter.ParseMultiPolygon Method 
 

Convert to an instance of `WkbMultiPolygon` from the wkt
...
**C#**<br />
``` C#
public static MultiPolygon ParseMultiPolygon(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseMultiPolygon ( 
	wkt As String
) As MultiPolygon
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPolygon">MultiPolygon</a><br />An instance of `WkbMultiPolygon`
