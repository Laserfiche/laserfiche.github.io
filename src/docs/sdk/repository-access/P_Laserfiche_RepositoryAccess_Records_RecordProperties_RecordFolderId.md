# RecordProperties.RecordFolderId Property 
...
**C#**<br />
``` C#
public int RecordFolderId { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property RecordFolderId As Integer
	Get
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_Records_IRecordProperties_RecordFolderId">IRecordProperties.RecordFolderId</a><br />
