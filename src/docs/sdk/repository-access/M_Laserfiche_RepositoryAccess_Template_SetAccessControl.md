# Template.SetAccessControl Method (Int32, TemplateSecurity, ISession)
...
#### Parameters
&nbsp;<dl><dt>templateId</dt><dd>Type: System.Int32<br />The ID of the template definition to set access control information for.</dd><dt>templateSecurity</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_TemplateSecurity">Laserfiche.RepositoryAccess.TemplateSecurity</a><br />A `TemplateSecurity` instance which represents the new access control settings for the specified template definition.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
