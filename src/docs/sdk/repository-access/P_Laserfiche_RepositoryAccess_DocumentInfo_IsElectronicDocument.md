# DocumentInfo.IsElectronicDocument Property 
...
**C#**<br />
``` C#
public bool IsElectronicDocument { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property IsElectronicDocument As Boolean
	Get
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IDocumentInfo_IsElectronicDocument">IDocumentInfo.IsElectronicDocument</a><br />
