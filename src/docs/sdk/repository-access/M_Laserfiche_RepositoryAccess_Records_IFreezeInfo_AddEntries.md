# IFreezeInfo.AddEntries Method (EntryInfo[])
...
``` VB
Sub AddEntries ( 
	addEntryInfos As EntryInfo()
)
```


#### Parameters
&nbsp;<dl><dt>addEntryInfos</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_EntryInfo">Laserfiche.RepositoryAccess.EntryInfo</a>[]<br /></dd></dl>
