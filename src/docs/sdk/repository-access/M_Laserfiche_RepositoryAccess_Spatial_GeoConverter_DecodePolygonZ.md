# GeoConverter.DecodePolygonZ Method 
 

Convert to an instance of `WkbPolygonZ` from the wkb
...
**C#**<br />
``` C#
public static PolygonZ DecodePolygonZ(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodePolygonZ ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_PolygonZ">PolygonZ</a><br />An instance of `WkbPolygonZ`
