# TrusteeInfo.AuditMaskAssigned Property 
...
**C#**<br />
``` C#
public bool AuditMaskAssigned { get; set; }
```

**VB**<br />
``` VB
Public Property AuditMaskAssigned As Boolean
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_ITrusteeInfo_AuditMaskAssigned">ITrusteeInfo.AuditMaskAssigned</a><br />
