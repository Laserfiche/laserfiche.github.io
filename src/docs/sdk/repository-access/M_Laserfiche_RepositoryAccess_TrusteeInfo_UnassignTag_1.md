# TrusteeInfo.UnassignTag Method (TagInfo)
...
#### Parameters
&nbsp;<dl><dt>tagInfo</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_TagInfo">Laserfiche.RepositoryAccess.TagInfo</a><br />A `TagInfo` instance representing the entry tag to unassign from the represented trustee.</dd></dl>

#### Return Value
Type: Boolean<br />True if the specified tag is known to be already assigned and will be unassigned, false otherwise.

#### Implements
<a href="M_Laserfiche_RepositoryAccess_ITrusteeInfo_UnassignTag_1">ITrusteeInfo.UnassignTag(TagInfo)</a><br />
