# GeoConverter.DecodeMultiPoint Method 
 

Convert to an instance of `WkbMultiPoint` from the wkb
...
**C#**<br />
``` C#
public static MultiPoint DecodeMultiPoint(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPoint ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPoint">MultiPoint</a><br />An instance of `WkbMultiPoint`
