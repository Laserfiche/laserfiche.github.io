...
public class RedactionAnnotation : TextAnnotation, 
	ISerializable
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RedactionAnnotation__ctor">RedactionAnnotation()</a></td><td>
Initializes a `RedactionAnnotation` instance representing a new redaction annotation.</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Laserfiche_RepositoryAccess_RedactionAnnotation__ctor_2">RedactionAnnotation(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the RedactionAnnotation class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RedactionAnnotation__ctor_1">RedactionAnnotation(Int32, Int64, ISession)</a></td><td>
Construct a `RedactionAnnotation` object which represents a new redaction annotation on the specified page.</td></tr></table>&nbsp;
<a href="#redactionannotation-class">Back to Top</a>
...
The type of Laserfiche annotation this object represents.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_AnnotationBase">AnnotationBase</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_RedactionAnnotation_Color">Color</a></td><td> (Overrides <a href="P_Laserfiche_RepositoryAccess_TextAnnotation_Color">TextAnnotation.Color</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_AnnotationBase_Comment">Comment</a></td><td>
...
A boolean indicating if the represented annotation is read-only because it is part of an archived version of the document.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_AnnotationBase">AnnotationBase</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_RedactionAnnotation_IsWhiteout">IsWhiteout</a></td><td>
Indicates if the redaction is a blackout or a whiteout of the underlying data.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_AnnotationBase_ItemId">ItemId</a></td><td>
