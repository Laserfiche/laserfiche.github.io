# Folder.GetStatistics Method (String, ISession)
 

Returns statistics about the specified Laserfiche folder, including information about all descendents..
...
#### Parameters
&nbsp;<dl><dt>path</dt><dd>Type: System.String<br />The path in the Laserfiche repository to the folder to return statistics for.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
