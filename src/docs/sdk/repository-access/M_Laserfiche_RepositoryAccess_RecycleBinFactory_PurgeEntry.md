# RecycleBinFactory.PurgeEntry Method (Guid, ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IRecycleBinFactory_PurgeEntry">IRecycleBinFactory.PurgeEntry(Guid, ISession)</a><br />
