# Entry.GetEffectiveRights Method (String, ISession)
...
#### Parameters
&nbsp;<dl><dt>entryPath</dt><dd>Type: System.String<br />The path in the current repository to the entry to return the current session's access to.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
