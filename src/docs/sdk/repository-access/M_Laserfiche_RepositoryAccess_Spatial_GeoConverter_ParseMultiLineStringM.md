# GeoConverter.ParseMultiLineStringM Method 
 

Convert to an instance of `WkbMultiLineStringM` from the wkt
...
**C#**<br />
``` C#
public static MultiLineStringM ParseMultiLineStringM(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseMultiLineStringM ( 
	wkt As String
) As MultiLineStringM
```
