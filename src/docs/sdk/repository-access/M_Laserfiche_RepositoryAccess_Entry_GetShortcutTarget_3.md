# Entry.GetShortcutTarget Method (String, ISession)
...
#### Parameters
&nbsp;<dl><dt>shortcutPath</dt><dd>Type: System.String<br />The path in the repository to the shortcut whose target entry shall be returned.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
