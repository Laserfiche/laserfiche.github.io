# AccountInfo.FailureAuditMask Property 
...
**C#**<br />
``` C#
public AuditClasses FailureAuditMask { get; set; }
```

**VB**<br />
``` VB
Public Property FailureAuditMask As AuditClasses
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IAccountInfo_FailureAuditMask">IAccountInfo.FailureAuditMask</a><br />
