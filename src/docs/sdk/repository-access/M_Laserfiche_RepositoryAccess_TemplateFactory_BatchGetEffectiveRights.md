# TemplateFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_ITemplateFactory_BatchGetEffectiveRights">ITemplateFactory.BatchGetEffectiveRights(IEnumerable(Int32), IEnumerable(AccountReference), ISession)</a><br />
