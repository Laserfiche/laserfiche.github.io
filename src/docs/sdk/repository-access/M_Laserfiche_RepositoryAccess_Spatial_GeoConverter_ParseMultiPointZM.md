# GeoConverter.ParseMultiPointZM Method 
 

Convert to an instance of `WkbMultiPointZM` from the wkt
...
**C#**<br />
``` C#
public static MultiPointZM ParseMultiPointZM(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseMultiPointZM ( 
	wkt As String
) As MultiPointZM
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPointZM">MultiPointZM</a><br />An instance of `WkbMultiPointZM`
