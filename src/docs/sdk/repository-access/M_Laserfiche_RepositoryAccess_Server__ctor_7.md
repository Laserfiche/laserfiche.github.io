# Server Constructor (String, Int32, Int32)
...
#### Parameters
&nbsp;<dl><dt>serverName</dt><dd>Type: System.String<br />The server's host name.</dd><dt>port</dt><dd>Type: System.Int32<br />The server's HTTP listening TCP port.</dd><dt>securePort</dt><dd>Type: System.Int32<br />The server's HTTPS listening TCP port.</dd></dl>
