# ITemplateFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
**C#**<br />
``` C#
Dictionary<int, Dictionary<AccountReference, int>> BatchGetEffectiveRights(
