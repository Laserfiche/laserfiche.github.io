# Document.ReadThumbnailPagePart Method 
 

Returns a `Thumbnail` instance which represents the image thumbnail associated with the specified page.
...
**C#**<br />
``` C#
public static Thumbnail ReadThumbnailPagePart(
	int entryId,
	int pageNum,
	ISession session
)
...
**VB**<br />
``` VB
Public Shared Function ReadThumbnailPagePart ( 
	entryId As Integer,
	pageNum As Integer,
	session As ISession
) As Thumbnail
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Thumbnail">Thumbnail</a><br />A `Thumbnail` instance which represents the image thumbnail associated with the specified page.
