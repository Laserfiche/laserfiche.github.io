# BriefcaseExporter.IncludeWorkingCopy Property 
...
**C#**<br />
``` C#
public bool IncludeWorkingCopy { get; set; }
```

**VB**<br />
``` VB
Public Property IncludeWorkingCopy As Boolean
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IBriefcaseExporter_IncludeWorkingCopy">IBriefcaseExporter.IncludeWorkingCopy</a><br />
