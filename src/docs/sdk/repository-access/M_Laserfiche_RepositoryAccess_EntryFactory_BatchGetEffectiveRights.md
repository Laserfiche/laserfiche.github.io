# EntryFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IEntryFactory_BatchGetEffectiveRights">IEntryFactory.BatchGetEffectiveRights(IEnumerable(Int32), IEnumerable(AccountReference), ISession)</a><br />

## See Also


#### Reference
<a href="T_Laserfiche_RepositoryAccess_EntryFactory">EntryFactory Class</a><br /><a href="Overload_Laserfiche_RepositoryAccess_EntryFactory_BatchGetEffectiveRights">BatchGetEffectiveRights Overload</a><br /><a href="N_Laserfiche_RepositoryAccess">Laserfiche.RepositoryAccess Namespace</a><br />