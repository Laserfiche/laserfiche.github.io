# TimeOfDay.LessThanOrEqual Operator 
 

Determines if the *tod1* argument represents a point in time equal to or before the *tod2* argument.
...
#### Return Value
Type: Boolean<br />True if the first argument represents a time before or equal to the second, false otherwise.
