# Account.LinkWindowsAccounts Method (String, IEnumerable(LFSecurityIdentifier), ISession)
...
#### Parameters
&nbsp;<dl><dt>accountName</dt><dd>Type: System.String<br />The name of the Laserfiche account that the specified set of Windows accounts will be linked to.</dd><dt>winSids</dt><dd>Type: System.Collections.Generic.IEnumerable(<a href="T_LfPortable_Security_Principal_LFSecurityIdentifier">LFSecurityIdentifier</a>)<br />A reference to a collection of Windows account references.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
