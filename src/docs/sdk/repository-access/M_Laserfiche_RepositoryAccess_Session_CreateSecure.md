# Session.CreateSecure Method (RepositoryRegistration)
 

Creates a new `Session` object and logs in to Laserfiche using the current thread's Windows credentials with SSL/TLS enabled.
