# ITemplateFactory.BatchGetDefaultAclDisplayRights Method (IEnumerable(AccountReference), ISession)
...
**C#**<br />
``` C#
Dictionary<AccountReference, int> BatchGetDefaultAclDisplayRights(
