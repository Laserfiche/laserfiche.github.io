# TimeOfDay.Addition Operator 
 

Adds an offset to the specified time, returning a new `TimeOfDay` value.
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Common_TimeOfDay">TimeOfDay</a><br />A `TimeOfDay` value representing the base time plus the specified offset.
