# FreezeFactory.GetFreezes Method (String, ISession, Dictionary(Int32, List(FrozenEntry)))
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_Records_IFreezeFactory_GetFreezes_3">IFreezeFactory.GetFreezes(String, ISession, Dictionary(Int32, List(FrozenEntry)))</a><br />
