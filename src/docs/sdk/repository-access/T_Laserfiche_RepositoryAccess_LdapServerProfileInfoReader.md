# LdapServerProfileInfoReader Class
 

Provides the ability to enumerate `LdapServerProfile` instances representing LDAP server profiles which match the specified criteria.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_LaserficheObjectReader_1">Laserfiche.RepositoryAccess.LaserficheObjectReader</a>(<a href="T_Laserfiche_RepositoryAccess_LdapServerProfileInfo">LdapServerProfileInfo</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Laserfiche.RepositoryAccess.LdapServerProfileInfoReader<br />
...
**C#**<br />
``` C#
public sealed class LdapServerProfileInfoReader : LaserficheObjectReader<LdapServerProfileInfo>
```

**VB**<br />
``` VB
Public NotInheritable Class LdapServerProfileInfoReader
	Inherits LaserficheObjectReader(Of LdapServerProfileInfo)
```

The LdapServerProfileInfoReader type exposes the following members.


## Properties
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_LdapServerProfileInfoReader_IsClosed">IsClosed</a></td><td> (Overrides <a href="P_Laserfiche_RepositoryAccess_LaserficheObjectReader_1_IsClosed">LaserficheObjectReader(T).IsClosed</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_LaserficheObjectReader_1_Item">Item</a></td><td>
