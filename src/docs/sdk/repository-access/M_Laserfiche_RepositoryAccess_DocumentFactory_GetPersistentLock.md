# DocumentFactory.GetPersistentLock Method 
...
**C#**<br />
``` C#
public IPersistentLock GetPersistentLock(
	int entryId,
	ISession session
)
```
...
**VB**<br />
``` VB
Public Function GetPersistentLock ( 
	entryId As Integer,
	session As ISession
) As IPersistentLock
```
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IDocumentFactory_GetPersistentLock">IDocumentFactory.GetPersistentLock(Int32, ISession)</a><br />
