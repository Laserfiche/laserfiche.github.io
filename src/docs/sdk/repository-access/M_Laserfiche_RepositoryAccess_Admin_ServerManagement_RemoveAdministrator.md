# ServerManagement.RemoveAdministrator Method 
...
**VB**<br />
``` VB
Public Sub RemoveAdministrator ( 
	account As IdentityReference
)
```


#### Parameters
&nbsp;<dl><dt>account</dt><dd>Type: System.Security.Principal.IdentityReference<br /></dd></dl>
