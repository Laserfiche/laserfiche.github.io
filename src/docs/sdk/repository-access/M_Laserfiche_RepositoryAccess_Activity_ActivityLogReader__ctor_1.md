# ActivityLogReader Constructor (SortDirection, ISession)
 

Initializes an `ActivityLogReader` instance configured to read the entire activity log in the specified order.
