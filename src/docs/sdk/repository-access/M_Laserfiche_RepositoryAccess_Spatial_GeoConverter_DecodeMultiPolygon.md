# GeoConverter.DecodeMultiPolygon Method 
 

Convert to an instance of `WkbMultiPolygon` from the wkb
...
**C#**<br />
``` C#
public static MultiPolygon DecodeMultiPolygon(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPolygon ( 
	wkb As Byte(),
