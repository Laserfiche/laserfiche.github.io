# RecycleBin.GetListing Method (RecycleBinColumn, SortDirection, ISession)
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_RecycleBinListing">RecycleBinListing</a><br />A `RecycleBinListing` instance which represents a listing of all the entries in the recycle bin.
