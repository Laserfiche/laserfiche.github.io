# RecycleBinListingRow.RestorePageAsync Method (String, PageRestoreOption, Int64)
 

Asynchronously restores the recycled page to the document specified by the provided entry path in the current repository, at the specified location in the document.
