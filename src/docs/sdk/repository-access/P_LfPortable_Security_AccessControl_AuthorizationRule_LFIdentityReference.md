# AuthorizationRule.LFIdentityReference Property 
...
**C#**<br />
``` C#
public LFIdentityReference LFIdentityReference { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property LFIdentityReference As LFIdentityReference
	Get
```
