# ChangeNumber.GetChangeNumbers Method (Dictionary(ChangeNumber.ObjectType, Int64), ISession)
...
public static void GetChangeNumbers(
	Dictionary<ChangeNumber.ObjectType, long> changeNumbers,
	ISession session
)
```
...
Public Shared Sub GetChangeNumbers ( 
	changeNumbers As Dictionary(Of ChangeNumber.ObjectType, Long),
	session As ISession
)
```
