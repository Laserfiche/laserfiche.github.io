# Template.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)
...
**C#**<br />
``` C#
public static Dictionary<int, Dictionary<SecurityIdentifier, int>> BatchGetEffectiveRights(
