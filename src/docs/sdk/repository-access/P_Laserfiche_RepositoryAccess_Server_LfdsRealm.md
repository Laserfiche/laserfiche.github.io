...
**C#**<br />
``` C#
public string LfdsRealm { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property LfdsRealm As String
	Get
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_IServer_LfdsRealm">IServer.LfdsRealm</a><br />
