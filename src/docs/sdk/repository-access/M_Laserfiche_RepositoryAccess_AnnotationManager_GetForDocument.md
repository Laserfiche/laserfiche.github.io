# AnnotationManager.GetForDocument Method 
...
**C#**<br />
``` C#
public ICollection<AnnotationBase> GetForDocument(
	int entryId,
	ISession session
)
```
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IAnnotationManager_GetForDocument">IAnnotationManager.GetForDocument(Int32, ISession)</a><br />
