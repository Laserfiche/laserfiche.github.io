# TemplateFactory.BatchGetAclDisplayRights Method (IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_ITemplateFactory_BatchGetAclDisplayRights_2">ITemplateFactory.BatchGetAclDisplayRights(IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)</a><br />
