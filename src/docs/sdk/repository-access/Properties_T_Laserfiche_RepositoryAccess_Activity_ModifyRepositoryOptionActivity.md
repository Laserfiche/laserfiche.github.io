# ModifyRepositoryOptionActivity Properties
 

The <a href="T_Laserfiche_RepositoryAccess_Activity_ModifyRepositoryOptionActivity">ModifyRepositoryOptionActivity</a> type exposes the following members.
...
Gets the SID of the user that initiated the activity for this record.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_Activity_ActivityRecord">ActivityRecord</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_Activity_ModifyRepositoryOptionActivity_OptionName">OptionName</a></td><td>
Gets the name of the modified repository option.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_Activity_ActivityRecord_RecordSource">RecordSource</a></td><td>
...
<a href="#modifyrepositoryoptionactivity-properties">Back to Top</a>

## See Also


#### Reference
<a href="T_Laserfiche_RepositoryAccess_Activity_ModifyRepositoryOptionActivity">ModifyRepositoryOptionActivity Class</a><br /><a href="N_Laserfiche_RepositoryAccess_Activity">Laserfiche.RepositoryAccess.Activity Namespace</a><br />