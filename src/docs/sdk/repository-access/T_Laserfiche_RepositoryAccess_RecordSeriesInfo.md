...
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_LaserficheObject">Laserfiche.RepositoryAccess.LaserficheObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_SecureLaserficheObject">Laserfiche.RepositoryAccess.SecureLaserficheObject</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_EntryInfo">Laserfiche.RepositoryAccess.EntryInfo</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_FolderInfo">Laserfiche.RepositoryAccess.FolderInfo</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Laserfiche.RepositoryAccess.RecordSeriesInfo<br />
...
public class RecordSeriesInfo : FolderInfo, 
	ISerializable, IRecordSeriesInfo, IFolderInfo, IEntryInfo, ISecureLaserficheObject, 
...
``` VB
<SerializableAttribute>
Public Class RecordSeriesInfo
	Inherits FolderInfo
	Implements ISerializable, IRecordSeriesInfo, IFolderInfo, IEntryInfo, 
	ISecureLaserficheObject, ILaserficheObject, IDisposable
```

The RecordSeriesInfo type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo__ctor">RecordSeriesInfo(ISession)</a></td><td>
Initializes a `RecordSeriesInfo` instance representing a new record series.</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo__ctor_1">RecordSeriesInfo(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the RecordSeriesInfo class</td></tr></table>&nbsp;
<a href="#recordseriesinfo-class">Back to Top</a>
...
Gets or sets a boolean that indicates if the server will automatically put all child documents of the folder under version control.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_EntryInfo_ClassificationLevel">ClassificationLevel</a></td><td>
Gets or sets the security classification level of the represented entry.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_EntryInfo">EntryInfo</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_RecordSeriesInfo_Code">Code</a></td><td>
Gets or sets the record series code.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_EntryInfo_Comment">Comment</a></td><td>
...
Gets or sets a boolean indicating whether the folder filter expression should be inherited from its parent.
...
Gets whether or not the folder that this instance represents is known to be a record folder.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_FolderInfo_IsUnderRecordSeries">IsUnderRecordSeries</a></td><td>
Gets whether or not the folder that this instance represents is known to directly or indirectly under a record series in the repository.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_EntryInfo_Language">Language</a></td><td>
...
Gets the path in the Laserfiche repository to the entry.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_EntryInfo">EntryInfo</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_LaserficheObject_Session">Session</a></td><td> (Inherited from <a href="T_Laserfiche_RepositoryAccess_LaserficheObject">LaserficheObject</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_RecordSeriesInfo_ShortName">ShortName</a></td><td>
Gets the short name of the record series, without the code prefix.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_EntryInfo_TemplateName">TemplateName</a></td><td>
...
Calculates the cutoff eligibility for the specified folder given a set of event dates.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_CalculateDispositionEligibilityDate">CalculateDispositionEligibilityDate(IEnumerable(KeyValuePair(Int32, DateTime)))</a></td><td>
...
Calculates the records management location that the represented record folder will be at on the specified date, if all transfer operations and records management dispositions are confirmed on their eligibility dates.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_CalculateTransferDates">CalculateTransferDates(IEnumerable(KeyValuePair(Int32, DateTime)))</a></td><td>
...
Confirms transfer for all records in the represented record folder that are eligible for transfer, using the specified transfer ID.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_CopyTo">CopyTo(String)</a></td><td>
...
Makes a copy of the represented entry asynchronously. The operation will occur immediately.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_EntryInfo">EntryInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo_Create_2">Create(String, EntryNameOption)</a></td><td> (Overrides <a href="M_Laserfiche_RepositoryAccess_FolderInfo_Create_2">FolderInfo.Create(String, EntryNameOption)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo_Create_3">Create(String, String, EntryNameOption)</a></td><td> (Overrides <a href="M_Laserfiche_RepositoryAccess_FolderInfo_Create_3">FolderInfo.Create(String, String, EntryNameOption)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo_Create">Create(IFolderInfo, String, EntryNameOption)</a></td><td> (Overrides <a href="M_Laserfiche_RepositoryAccess_FolderInfo_Create">FolderInfo.Create(IFolderInfo, String, EntryNameOption)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo_Create_1">Create(IFolderInfo, String, String, EntryNameOption)</a></td><td> (Overrides <a href="M_Laserfiche_RepositoryAccess_FolderInfo_Create_1">FolderInfo.Create(IFolderInfo, String, String, EntryNameOption)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_CreateLinkTo">CreateLinkTo</a></td><td>
...
Get a suggestion name of an entry can be created under the folder that this instance represents.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo_GetObjectData">GetObjectData</a></td><td> (Overrides <a href="M_Laserfiche_RepositoryAccess_EntryInfo_GetObjectData">EntryInfo.GetObjectData(SerializationInfo, StreamingContext)</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_GetParentFolder">GetParentFolder</a></td><td> (Inherited from <a href="T_Laserfiche_RepositoryAccess_EntryInfo">EntryInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_FolderInfo_GetRFProperties">GetRFProperties</a></td><td> (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_RecordSeriesInfo_GetSeriesProperties">GetSeriesProperties</a></td><td>
Return a `RecordSeriesProperties` instance which describes most of the records management properties of the represented record series.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_GetShortcuts">GetShortcuts</a></td><td>
...
Returns a `FolderStatistics` instance which represents the statistics for the folder that this instance represents, gathering data for all descendent entries.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_FolderInfo_GetStatistics_1">GetStatistics(EntryDepth)</a></td><td>
Returns a `FolderStatistics` instance which represents the statistics for the folder that this instance represents.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td>GetType</td><td> (Inherited from Object.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_ImbueLock">ImbueLock</a></td><td>
...
Forwarding function for openFolderListing(EntryListingSettings settings)
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_FolderInfo_OpenFolderListing_1">OpenFolderListing(EntryListingSettings, Int32)</a></td><td>
Forwarding function for OpenFolderListing(EntryListingSettings settings, int preload)
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_Refresh">Refresh</a></td><td> (Inherited from <a href="T_Laserfiche_RepositoryAccess_EntryInfo">EntryInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_RemoveLinkTo">RemoveLinkTo</a></td><td>
...
Set the folder as a record folder. The operation will occur immediately.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_EntryInfo_SetTemplate">SetTemplate(String)</a></td><td>
...
Unset the folder as a record folder. The operation will occur immediately.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_FolderInfo">FolderInfo</a>.)</td></tr></table>&nbsp;
<a href="#recordseriesinfo-class">Back to Top</a>
