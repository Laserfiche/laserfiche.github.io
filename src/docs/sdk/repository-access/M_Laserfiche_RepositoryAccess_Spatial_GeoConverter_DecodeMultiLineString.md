# GeoConverter.DecodeMultiLineString Method 
 

Convert to an instance of `WkbMultiLineString` from the wkb
...
**C#**<br />
``` C#
public static MultiLineString DecodeMultiLineString(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiLineString ( 
	wkb As Byte(),
