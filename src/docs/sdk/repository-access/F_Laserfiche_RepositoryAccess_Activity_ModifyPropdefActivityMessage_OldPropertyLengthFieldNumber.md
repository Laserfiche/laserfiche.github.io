# ModifyPropdefActivityMessage.OldPropertyLengthFieldNumber Field
 

Field number for the "old_property_length" field.
...
**C#**<br />
``` C#
public const int OldPropertyLengthFieldNumber = 9
```

**VB**<br />
``` VB
Public Const OldPropertyLengthFieldNumber As Integer = 9
```
