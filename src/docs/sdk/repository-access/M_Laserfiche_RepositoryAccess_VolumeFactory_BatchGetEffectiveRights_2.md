# VolumeFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IVolumeFactory_BatchGetEffectiveRights_2">IVolumeFactory.BatchGetEffectiveRights(IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)</a><br />
