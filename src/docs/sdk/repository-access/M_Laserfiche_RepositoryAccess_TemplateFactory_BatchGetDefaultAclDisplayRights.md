# TemplateFactory.BatchGetDefaultAclDisplayRights Method (IEnumerable(AccountReference), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_ITemplateFactory_BatchGetDefaultAclDisplayRights">ITemplateFactory.BatchGetDefaultAclDisplayRights(IEnumerable(AccountReference), ISession)</a><br />
