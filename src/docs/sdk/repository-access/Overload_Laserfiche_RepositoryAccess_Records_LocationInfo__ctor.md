...
Initializes a new instance of the <a href="T_Laserfiche_RepositoryAccess_Records_LocationInfo">LocationInfo</a> class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_Records_LocationInfo__ctor_3">LocationInfo(Int32, ISession)</a></td><td>
For Laserfiche internal use only.</td></tr></table>&nbsp;
<a href="#locationinfo-constructor">Back to Top</a>

## See Also


#### Reference
<a href="T_Laserfiche_RepositoryAccess_Records_LocationInfo">LocationInfo Class</a><br /><a href="N_Laserfiche_RepositoryAccess_Records">Laserfiche.RepositoryAccess.Records Namespace</a><br />