# TimeOfDay.GreaterThanOrEqual Operator 
 

Determines if the *tod1* argument represents a point in time after the *tod2* argument.
...
#### Return Value
Type: Boolean<br />True if the first argument represents a time after or equal to the second, false otherwise.
