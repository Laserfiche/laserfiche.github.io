# EntryLockListing.GetListing Method (LFIdentityReference, Int32, PersistentLockColumn, SortDirection, ISession)
...
**C#**<br />
``` C#
public static EntryLockListing GetListing(
...
#### Reference
<a href="T_Laserfiche_RepositoryAccess_EntryLockListing">EntryLockListing Class</a><br /><a href="Overload_Laserfiche_RepositoryAccess_EntryLockListing_GetListing">GetListing Overload</a><br /><a href="N_Laserfiche_RepositoryAccess">Laserfiche.RepositoryAccess Namespace</a><br />