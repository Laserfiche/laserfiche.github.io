# GeoConverter.DecodeMultiPointZM Method 
 

Convert to an instance of `WkbMultiPointZM` from the wkb
...
**C#**<br />
``` C#
public static MultiPointZM DecodeMultiPointZM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPointZM ( 
	wkb As Byte(),
