# Volume.EnumAll Method (VolumeReaderOptions, VolumeReaderProperties, ISession)
...
#### Parameters
&nbsp;<dl><dt>options</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_VolumeReaderOptions">Laserfiche.RepositoryAccess.VolumeReaderOptions</a><br />Members of the `VolumeReaderOptions` enumeration which control which volumes will be returned by the reader.</dd><dt>properties</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_VolumeReaderProperties">Laserfiche.RepositoryAccess.VolumeReaderProperties</a><br />Members of the `VolumeReaderProperty` enumeration which control which volume properties will be returned by the reader.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
