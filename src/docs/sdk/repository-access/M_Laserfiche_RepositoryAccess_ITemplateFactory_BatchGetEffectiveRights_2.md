# ITemplateFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)
...
**C#**<br />
``` C#
Dictionary<int, Dictionary<SecurityIdentifier, int>> BatchGetEffectiveRights(
