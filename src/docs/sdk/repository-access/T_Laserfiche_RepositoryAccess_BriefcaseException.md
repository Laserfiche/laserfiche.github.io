# BriefcaseException Class
 

Represents an error when processing (importing/exporting) a Laserfiche briefcase.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;System.Exception<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_LaserficheRepositoryException">Laserfiche.RepositoryAccess.LaserficheRepositoryException</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Laserfiche.RepositoryAccess.BriefcaseException<br />
...
public class BriefcaseException : LaserficheRepositoryException
```

**VB**<br />
``` VB
<SerializableAttribute>
Public Class BriefcaseException
	Inherits LaserficheRepositoryException
```

The BriefcaseException type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_BriefcaseException__ctor">BriefcaseException()</a></td><td>
Initializes a `BriefcaseException` instance.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_BriefcaseException__ctor_2">BriefcaseException(String)</a></td><td>
Initializes a `BriefcaseException` instance with the specified message.</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="M_Laserfiche_RepositoryAccess_BriefcaseException__ctor_1">BriefcaseException(SerializationInfo, StreamingContext)</a></td><td>
Initializes a new instance of the BriefcaseException class</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_BriefcaseException__ctor_3">BriefcaseException(String, Exception)</a></td><td>
Initializes a `BriefcaseException` instance with the specified message and inner exception.</td></tr></table>&nbsp;
<a href="#briefcaseexception-class">Back to Top</a>
