# SessionLocale.TokenSpelling Property 
...
**C#**<br />
``` C#
public string TokenSpelling { get; set; }
```

**VB**<br />
``` VB
Public Property TokenSpelling As String
	Get
	Set
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_ILfLocale_TokenSpelling">ILfLocale.TokenSpelling</a><br />
