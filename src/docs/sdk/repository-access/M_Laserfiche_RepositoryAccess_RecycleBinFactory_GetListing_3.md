# RecycleBinFactory.GetListing Method (Int32, RecycleBinColumn, SortDirection, ISession)
 

Returns a `IRecycleBinListing` instance which represents a listing of all the entries in the recycle bin that share the same parent entry.
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_IRecycleBinListing">IRecycleBinListing</a><br />A `IRecycleBinListing` instance which represents a listing of all the entries in the recycle bin that share the same parent entry.

#### Implements
<a href="M_Laserfiche_RepositoryAccess_IRecycleBinFactory_GetListing_3">IRecycleBinFactory.GetListing(Int32, RecycleBinColumn, SortDirection, ISession)</a><br />
