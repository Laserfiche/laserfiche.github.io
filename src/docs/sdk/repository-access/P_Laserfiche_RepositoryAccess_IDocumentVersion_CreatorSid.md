# IDocumentVersion.CreatorSid Property 
 

Gets a `SecurityIdentifier` instance which represents the security identifier (SID) of the user that created the represented version.
...
**C#**<br />
``` C#
LFSecurityIdentifier CreatorSid { get; }
```

**VB**<br />
``` VB
ReadOnly Property CreatorSid As LFSecurityIdentifier
	Get
```
