# RecordProperties.CutoffEligibility Property 
...
**C#**<br />
``` C#
public DateTime CutoffEligibility { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property CutoffEligibility As DateTime
	Get
```
...
#### Implements
<a href="P_Laserfiche_RepositoryAccess_Records_IRecordProperties_CutoffEligibility">IRecordProperties.CutoffEligibility</a><br />
