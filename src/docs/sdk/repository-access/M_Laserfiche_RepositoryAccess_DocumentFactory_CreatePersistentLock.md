# DocumentFactory.CreatePersistentLock Method 
...
**C#**<br />
``` C#
public IPersistentLock CreatePersistentLock(
	DocumentInfo doc,
	string comment,
	ISession session,
...
**VB**<br />
``` VB
Public Function CreatePersistentLock ( 
	doc As DocumentInfo,
	comment As String,
	session As ISession,
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IDocumentFactory_CreatePersistentLock">IDocumentFactory.CreatePersistentLock(DocumentInfo, String, ISession, LockExtent)</a><br />
