# LongOperation.ErrorCode Property 
 

Gets the Laserfiche error code that was set by the long operation after it completed. Only valid for completed operations.
