# GeoConverter.ParseLineString Method 
 

Convert to an instance of `WkbLineString` from the wkt
...
**C#**<br />
``` C#
public static LineString ParseLineString(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseLineString ( 
	wkt As String
) As LineString
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineString">LineString</a><br />An instance of `WkbStringLine`
