# VolumeFactory.BatchGetEffectiveRights Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
**C#**<br />
``` C#
public Dictionary<int, Dictionary<AccountReference, int>> BatchGetEffectiveRights(
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IVolumeFactory_BatchGetEffectiveRights">IVolumeFactory.BatchGetEffectiveRights(IEnumerable(Int32), IEnumerable(AccountReference), ISession)</a><br />

## See Also


#### Reference
<a href="T_Laserfiche_RepositoryAccess_VolumeFactory">VolumeFactory Class</a><br /><a href="Overload_Laserfiche_RepositoryAccess_VolumeFactory_BatchGetEffectiveRights">BatchGetEffectiveRights Overload</a><br /><a href="N_Laserfiche_RepositoryAccess">Laserfiche.RepositoryAccess Namespace</a><br />