# GeoConverter.DecodePolygonZM Method 
 

Convert to an instance of `WkbPolygonZM` from the wkb
...
**C#**<br />
``` C#
public static PolygonZM DecodePolygonZM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodePolygonZM ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_PolygonZM">PolygonZM</a><br />An instance of `WkbPolygonZM`
