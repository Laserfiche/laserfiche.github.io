# AnnotationManager.UpdateAnnotationReasons Method 
...
**C#**<br />
``` C#
public void UpdateAnnotationReasons(
...
**VB**<br />
``` VB
Public Sub UpdateAnnotationReasons ( 
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IAnnotationManager_UpdateAnnotationReasons">IAnnotationManager.UpdateAnnotationReasons(IList(AnnotationReasonCommand), IList(AnnotationReasonCommandResult), ISession)</a><br />
