# GeoConverter.DecodeLineString Method 
 

Convert to an instance of `WkbLineString` from the wkb
...
**C#**<br />
``` C#
public static LineString DecodeLineString(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeLineString ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineString">LineString</a><br />An instance of `WkbLineString`
