# UnmountRepositoryOptions Enumeration
...
``` C#
[FlagsAttribute]
public enum UnmountRepositoryOptions
```

**VB**<br />
``` VB
<FlagsAttribute>
Public Enumeration UnmountRepositoryOptions
```


## Members
&nbsp;<table><tr><th></th><th>Member name</th><th>Value</th><th>Description</th></tr><tr><td /><td target="F:Laserfiche.RepositoryAccess.Admin.UnmountRepositoryOptions.None">**None**</td><td>0</td><td>No option specified.</td></tr><tr><td /><td target="F:Laserfiche.RepositoryAccess.Admin.UnmountRepositoryOptions.ForceUnmount">**ForceUnmount**</td><td>1</td><td>Force the repository to be unmounted if necessary.</td></tr></table>
