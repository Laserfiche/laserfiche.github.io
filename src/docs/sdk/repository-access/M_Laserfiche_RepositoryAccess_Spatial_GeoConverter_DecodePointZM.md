# GeoConverter.DecodePointZM Method 
 

Convert to an instance of `WkbPointZM` from the wkb
...
**C#**<br />
``` C#
public static PointZM DecodePointZM(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodePointZM ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_PointZM">PointZM</a><br />An instance of `WkbPointZM`
