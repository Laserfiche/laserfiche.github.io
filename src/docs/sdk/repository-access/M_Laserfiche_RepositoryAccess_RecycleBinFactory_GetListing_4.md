# RecycleBinFactory.GetListing Method (Int32, RecycleBinColumn, SortDirection, LFSecurityIdentifier, ISession)
 

Returns a `IRecycleBinListing` instance which represents a listing of all the entries in the recycle bin that share the same parent entry that were moved there (i.e., deleted) by the specified user.
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_IRecycleBinListing">IRecycleBinListing</a><br />A `IRecycleBinListing` instance which represents a listing of all the entries in the recycle bin that share the same parent entry that were moved there (i.e., deleted) by the specified user.

#### Implements
<a href="M_Laserfiche_RepositoryAccess_IRecycleBinFactory_GetListing_4">IRecycleBinFactory.GetListing(Int32, RecycleBinColumn, SortDirection, LFSecurityIdentifier, ISession)</a><br />
