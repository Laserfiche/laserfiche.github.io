...
**C#**<br />
``` C#
public interface IRecycleBinFactory
```
...
The IRecycleBinFactory type exposes the following members.
...
<a href="#irecyclebinfactory-interface">Back to Top</a>
