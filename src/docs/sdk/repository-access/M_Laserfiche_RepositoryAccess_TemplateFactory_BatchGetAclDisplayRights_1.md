# TemplateFactory.BatchGetAclDisplayRights Method (IEnumerable(Int32), IEnumerable(LFSecurityIdentifier), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_ITemplateFactory_BatchGetAclDisplayRights_1">ITemplateFactory.BatchGetAclDisplayRights(IEnumerable(Int32), IEnumerable(LFSecurityIdentifier), ISession)</a><br />
