# GeoConverter.ParseLineStringM Method 
 

Convert to an instance of `WkbLineStringM` from the wkt
...
**C#**<br />
``` C#
public static LineStringM ParseLineStringM(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseLineStringM ( 
	wkt As String
) As LineStringM
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineStringM">LineStringM</a><br />An instance of `WkbStringLineM`
