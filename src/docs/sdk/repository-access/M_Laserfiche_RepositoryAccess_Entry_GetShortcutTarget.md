# Entry.GetShortcutTarget Method (FolderInfo, String, ISession)
...
#### Parameters
&nbsp;<dl><dt>parentFolder</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_FolderInfo">Laserfiche.RepositoryAccess.FolderInfo</a><br />A `FolderInfo` instance representing the parent folder of the shortcut.</dd><dt>shortcutName</dt><dd>Type: System.String<br />The name of the shortcut in the folder whose target entry shall be returned.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
