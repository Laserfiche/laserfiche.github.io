# Trustee.SetInfo Method (Int32, TrusteeInfo, ISession)
...
#### Parameters
&nbsp;<dl><dt>trusteeId</dt><dd>Type: System.Int32<br />The ID of the Laserfiche account to set the trustee information for.</dd><dt>info</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_TrusteeInfo">Laserfiche.RepositoryAccess.TrusteeInfo</a><br />A `TrusteeInfo` instance that specifies the new Laserfiche trustee settings for the trustee.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
