# ModifyPropdefActivityMessage.Parser Property 
...
**C#**<br />
``` C#
public static MessageParser<ModifyPropdefActivityMessage> Parser { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Parser As MessageParser(Of ModifyPropdefActivityMessage)
	Get
```


#### Property Value
Type: MessageParser(<a href="T_Laserfiche_RepositoryAccess_Activity_ModifyPropdefActivityMessage">ModifyPropdefActivityMessage</a>)
