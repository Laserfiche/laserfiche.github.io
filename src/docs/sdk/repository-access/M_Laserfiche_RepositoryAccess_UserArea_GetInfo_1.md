# UserArea.GetInfo Method (String, ISession)
 

Returns a `UserAreaInfo` instance which describes the specified user area in Laserfiche. This method will only lookup user areas owned by the caller.
...
#### Parameters
&nbsp;<dl><dt>userAreaName</dt><dd>Type: System.String<br />The name of the user area to retrieve information about.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
