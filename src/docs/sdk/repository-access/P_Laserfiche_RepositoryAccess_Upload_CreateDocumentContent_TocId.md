# CreateDocumentContent.TocId Property 
 

Gets the id of the new document if is created successfully.
...
**C#**<br />
``` C#
public int TocId { get; }
```

**VB**<br />
``` VB
Public ReadOnly Property TocId As Integer
	Get
```
