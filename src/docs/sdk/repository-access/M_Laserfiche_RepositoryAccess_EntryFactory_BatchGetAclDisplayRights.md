# EntryFactory.BatchGetAclDisplayRights Method (IEnumerable(Int32), IEnumerable(AccountReference), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IEntryFactory_BatchGetAclDisplayRights">IEntryFactory.BatchGetAclDisplayRights(IEnumerable(Int32), IEnumerable(AccountReference), ISession)</a><br />
