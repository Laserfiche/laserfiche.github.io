...
A collection of static methods for managing user areas in a Laserfiche repository.


## Inheritance Hierarchy
System.Object<br />&nbsp;&nbsp;Laserfiche.RepositoryAccess.UserArea<br />
...
**VB**<br />
``` VB
Public NotInheritable Class UserArea
```

The UserArea type exposes the following members.
...
<a href="#userarea-class">Back to Top</a>
