# IEntryInfo.CalculateTransferEligibility Method 
...
**C#**<br />
``` C#
DateTime CalculateTransferEligibility(
	int transferId
)
```
...
**VB**<br />
``` VB
Function CalculateTransferEligibility ( 
...
#### Parameters
&nbsp;<dl><dt>transferId</dt><dd>Type: System.Int32<br /></dd></dl>
