# IDispositionScheduleInfo.AlternateScheduleTriggerEventId Property 
...
**C#**<br />
``` C#
int AlternateScheduleTriggerEventId { get; }
```

**VB**<br />
``` VB
ReadOnly Property AlternateScheduleTriggerEventId As Integer
	Get
```
