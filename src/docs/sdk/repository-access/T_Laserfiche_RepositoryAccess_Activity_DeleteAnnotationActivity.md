# DeleteAnnotationActivity Class
...
public sealed class DeleteAnnotationActivity : AnnotationActivity
```

**VB**<br />
``` VB
<SerializableAttribute>
Public NotInheritable Class DeleteAnnotationActivity
	Inherits AnnotationActivity
```

The DeleteAnnotationActivity type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_Laserfiche_RepositoryAccess_Activity_DeleteAnnotationActivity__ctor">DeleteAnnotationActivity</a></td><td>
Initializes a new instance of the DeleteAnnotationActivity class</td></tr></table>&nbsp;
<a href="#deleteannotationactivity-class">Back to Top</a>
