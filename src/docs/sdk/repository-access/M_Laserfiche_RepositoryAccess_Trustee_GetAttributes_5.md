# Trustee.GetAttributes Method (LFIdentityReference, String, IEnumerable(String), ISession)
...
#### Parameters
&nbsp;<dl><dt>ident</dt><dd>Type: <a href="T_LfPortable_Security_Principal_LFIdentityReference">LfPortable.Security.Principal.LFIdentityReference</a><br />An `IdentityReference` which represents a reference to the trustee to retrieve the attribute collection for.</dd><dt>filter</dt><dd>Type: System.String<br />A string prefix filter for the trustee attribute names. No filter is applied if `null`.</dd><dt>prefixes</dt><dd>Type: System.Collections.Generic.IEnumerable(String)<br />A collection of name prefixes. Names must match at least one of the prefixes. Ignored if `null` is passed.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
