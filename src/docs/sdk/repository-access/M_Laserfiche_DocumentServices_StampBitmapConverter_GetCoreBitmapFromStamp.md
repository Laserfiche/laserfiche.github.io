# StampBitmapConverter.GetCoreBitmapFromStamp Method (StampInfo, LfColor)
...
#### Return Value
Type: LfWriteableBitmap<br />A bitmap from the provided Laserfiche stamp using the specified color.
