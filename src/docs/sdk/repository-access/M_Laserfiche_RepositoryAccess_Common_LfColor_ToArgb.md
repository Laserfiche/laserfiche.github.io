# LfColor.ToArgb Method 
 

Returns an integer representing the color value stored in this object in ARGB byte order.
...
#### Return Value
Type: Int32<br />An integer representing a color in ARGB byte order.
