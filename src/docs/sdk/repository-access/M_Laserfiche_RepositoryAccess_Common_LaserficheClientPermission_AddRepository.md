# LaserficheClientPermission.AddRepository Method 
 

Add permission to access a repository to the access set of this code permission. If access was already specified for the Laserfiche server and repository name, the access level is combined.
