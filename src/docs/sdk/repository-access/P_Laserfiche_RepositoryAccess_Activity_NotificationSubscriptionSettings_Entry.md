# NotificationSubscriptionSettings.Entry Property 
 

Gets or sets the `EntryInfo` instance representing the entry used as the base for activities to subscribe to.
...
**VB**<br />
``` VB
Public Property Entry As EntryInfo
	Get
	Set
```
