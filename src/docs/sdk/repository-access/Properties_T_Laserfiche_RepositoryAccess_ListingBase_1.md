# ListingBase(*T*) Properties
 

The <a href="T_Laserfiche_RepositoryAccess_ListingBase_1">ListingBase(T)</a> generic type exposes the following members.
...
<a href="#listingbase(*t*)-properties">Back to Top</a>
