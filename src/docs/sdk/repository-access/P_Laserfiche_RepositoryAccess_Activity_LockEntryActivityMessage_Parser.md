# LockEntryActivityMessage.Parser Property 
...
**C#**<br />
``` C#
public static MessageParser<LockEntryActivityMessage> Parser { get; }
```

**VB**<br />
``` VB
Public Shared ReadOnly Property Parser As MessageParser(Of LockEntryActivityMessage)
	Get
```


#### Property Value
Type: MessageParser(<a href="T_Laserfiche_RepositoryAccess_Activity_LockEntryActivityMessage">LockEntryActivityMessage</a>)
