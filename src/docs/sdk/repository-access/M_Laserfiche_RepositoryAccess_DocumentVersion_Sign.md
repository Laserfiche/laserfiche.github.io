...
#### Parameters
&nbsp;<dl><dt>signature</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_DocumentSignatureInfo">Laserfiche.RepositoryAccess.DocumentSignatureInfo</a><br />A `DocumentSignatureInfo` instance which contains the settings used to sign the document version.</dd></dl>
