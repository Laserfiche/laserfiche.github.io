# GeoConverter.ParseLineStringZM Method 
 

Convert to an instance of `WkbLineStringZM` from the wkt
...
**C#**<br />
``` C#
public static LineStringZM ParseLineStringZM(
	string wkt
)
```
...
**VB**<br />
``` VB
Public Shared Function ParseLineStringZM ( 
	wkt As String
) As LineStringZM
```
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineStringZM">LineStringZM</a><br />An instance of `WkbStringLineZM`
