# DocumentFactory.GetPersistentLocks Method 
...
**C#**<br />
``` C#
public IList<IPersistentLock> GetPersistentLocks(
	int entryId,
	ISession session
)
```
...
**VB**<br />
``` VB
Public Function GetPersistentLocks ( 
	entryId As Integer,
	session As ISession
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IDocumentFactory_GetPersistentLocks">IDocumentFactory.GetPersistentLocks(Int32, ISession)</a><br />
