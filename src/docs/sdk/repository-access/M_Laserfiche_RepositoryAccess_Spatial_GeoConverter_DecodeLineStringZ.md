# GeoConverter.DecodeLineStringZ Method 
 

Convert to an instance of `WkbLineStringZ` from the wkb
...
**C#**<br />
``` C#
public static LineStringZ DecodeLineStringZ(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeLineStringZ ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_LineStringZ">LineStringZ</a><br />An instance of `WkbLineStringZ`
