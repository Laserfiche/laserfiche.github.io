# VolumeAttachSettings.IsWriteOnce Property 
 

Gets or sets a boolean indicating if the volume will be write-once after attaching.
...
**VB**<br />
``` VB
Public Property IsWriteOnce As Boolean
	Get
	Set
```
