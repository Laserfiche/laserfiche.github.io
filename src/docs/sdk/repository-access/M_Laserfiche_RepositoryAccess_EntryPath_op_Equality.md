# EntryPath.Equality Operator 
 

Determines if two `RepositoryPath` instances are equivalent.
...
#### Return Value
Type: Boolean<br />True if the arguments represent equivalent paths, false otherwise.
