# ITemplateFactory.BatchGetAclDisplayRights Method (IEnumerable(Int32), IEnumerable(SecurityIdentifier), ISession)
...
**C#**<br />
``` C#
Dictionary<int, Dictionary<SecurityIdentifier, int>> BatchGetAclDisplayRights(
...
#### Reference
<a href="T_Laserfiche_RepositoryAccess_ITemplateFactory">ITemplateFactory Interface</a><br /><a href="Overload_Laserfiche_RepositoryAccess_ITemplateFactory_BatchGetAclDisplayRights">BatchGetAclDisplayRights Overload</a><br /><a href="N_Laserfiche_RepositoryAccess">Laserfiche.RepositoryAccess Namespace</a><br />