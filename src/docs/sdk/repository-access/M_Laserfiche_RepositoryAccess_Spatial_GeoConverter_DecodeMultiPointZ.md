# GeoConverter.DecodeMultiPointZ Method 
 

Convert to an instance of `WkbMultiPointZ` from the wkb
...
**C#**<br />
``` C#
public static MultiPointZ DecodeMultiPointZ(
	byte[] wkb,
	ref int pos
)
```
...
**VB**<br />
``` VB
Public Shared Function DecodeMultiPointZ ( 
	wkb As Byte(),
...
#### Return Value
Type: <a href="T_Laserfiche_RepositoryAccess_Spatial_MultiPointZ">MultiPointZ</a><br />An instance of `WkbMultiPointZ`
