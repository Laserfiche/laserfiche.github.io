# AccountReference.Equality Operator 
 

Determines if two `AccountReference` object references refer to the same Laserfiche account.
...
#### Return Value
Type: Boolean<br />True if both arguments reference the same Laserfiche account or if both arguments are null object references, otherwise false is returned.
