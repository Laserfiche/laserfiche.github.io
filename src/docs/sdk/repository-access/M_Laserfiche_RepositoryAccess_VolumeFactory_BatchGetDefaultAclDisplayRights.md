# VolumeFactory.BatchGetDefaultAclDisplayRights Method (IEnumerable(AccountReference), ISession)
...
#### Implements
<a href="M_Laserfiche_RepositoryAccess_IVolumeFactory_BatchGetDefaultAclDisplayRights">IVolumeFactory.BatchGetDefaultAclDisplayRights(IEnumerable(AccountReference), ISession)</a><br />
