# DispositionSchedule.GetInfo Method (String, ISession)
...
#### Parameters
&nbsp;<dl><dt>name</dt><dd>Type: System.String<br />The name of the disposition schedule to retrieve information about.</dd><dt>session</dt><dd>Type: <a href="T_Laserfiche_RepositoryAccess_ISession">Laserfiche.RepositoryAccess.ISession</a><br />The Laserfiche session to use.</dd></dl>
