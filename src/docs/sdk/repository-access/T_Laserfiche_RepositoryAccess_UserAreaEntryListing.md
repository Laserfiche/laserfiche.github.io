...
System.Object<br />&nbsp;&nbsp;System.MarshalByRefObject<br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="T_Laserfiche_RepositoryAccess_EntryListingBase">Laserfiche.RepositoryAccess.EntryListingBase</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Laserfiche.RepositoryAccess.UserAreaEntryListing<br />
...
public class UserAreaEntryListing : EntryListingBase, 
	IUserAreaEntryListing, IEntryListingBase, IEnumerable, IDisposable, IEnumerable<EntryListingRow>
```

**VB**<br />
``` VB
<SerializableAttribute>
Public Class UserAreaEntryListing
	Inherits EntryListingBase
	Implements IUserAreaEntryListing, IEntryListingBase, IEnumerable, IDisposable, 
	IEnumerable(Of EntryListingRow)
```

The UserAreaEntryListing type exposes the following members.
...
Gets or sets the settings used for this entry listing instance.
 (Inherited from <a href="T_Laserfiche_RepositoryAccess_EntryListingBase">EntryListingBase</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_Laserfiche_RepositoryAccess_UserAreaEntryListing_UserArea">UserArea</a></td><td>
Gets the `UserAreaInfo` instance representing the user area whose contents are contained in the represented entry listing.</td></tr></table>&nbsp;
<a href="#userareaentrylisting-class">Back to Top</a>
